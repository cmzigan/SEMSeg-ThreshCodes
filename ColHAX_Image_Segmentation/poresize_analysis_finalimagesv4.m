...
%         writecell(trials(j),'poresize.xlsx','Sheet',geltype{i},'WriteMode','append')
        ...
        for n=1:Nim
            ...
            % if i==1 %Originially the first image had dif settings, we
            % dont need that in the end
            %     [BW,maskedImage] = segmentImage5(img1crop); %Larger open bin for 2A2C
