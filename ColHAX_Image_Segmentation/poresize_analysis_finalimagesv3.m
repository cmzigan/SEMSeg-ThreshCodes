...
%basedir='/MATLAB Drive/Claudai/Analyzed Images Final/';
%Load file input location
%basedir2='/MATLAB Drive/Claudai';
...
%ycrop=880; 
magnification=0.504;%(%pixels/microns)- 504 pixels/ mm
...
%         writecell(trials(j),'poresize.xlsx','Sheet',geltype{i},'WriteMode','append')
        ...
        for n=1:Nim
            ...
            if i==1
                [BW,maskedImage] = segmentImageHAX(img1crop); %Binary image??
